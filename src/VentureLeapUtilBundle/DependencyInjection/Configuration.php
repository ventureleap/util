...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder
            ->root('venture_leap_util')
                ->children()
                    ->arrayNode('email')
                        ->children()
                            ->scalarNode('sender_address')->defaultValue('mail@VentureLeap.de')->end()
                            ->scalarNode('sender_name')->defaultValue('VentureLeap')->end()
                        ->end()
                    ->end()
                    ->arrayNode('aws')
                        ->children()
                            ...
                            ->scalarNode('s3_bucket')->defaultValue('VentureLeap-dev')->end()
                    ...
                    ->arrayNode('asset')
                        ->children()
                            ...
                            ->scalarNode('folder')->defaultValue('venture_leap_dev/')->end()
                            ->arrayNode('images')
                                ->defaultValue([])
                                ->prototype('array')
                                    ->children()
